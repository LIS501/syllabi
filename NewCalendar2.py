...
SemGenBackground = SemGenLabel = ""


for s in mygraph.subjects(RDF.type, l501.Semester):
	for i in mygraph.objects(s,dc.subject):
	        for r in mygraph.objects(i,l501.backgroundReading):
                        SemGenBackground = r
                for l in mygraph.objects(i,skos.prefLabel):
                        SemGenLabel = str(l)
...
print '## ' + SemGenLabel
if SemGenBackground:
        filename = str(SemGenBackground)[5:] + '.md'
